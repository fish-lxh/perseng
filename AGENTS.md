...
This project is indexed by GitNexus as **perseng** (13245 symbols, 26804 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
