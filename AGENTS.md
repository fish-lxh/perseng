...
This project is indexed by GitNexus as **perseng** (12660 symbols, 25526 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
