...
This project is indexed by GitNexus as **perseng** (11501 symbols, 22819 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
