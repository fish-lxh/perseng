...
如需绑定项目，请提供 workingDirectory 参数。`
    ...
    return `🎯 Perseng 初始化完成！

## 📦 版本信息
✅ **Perseng v${version}** - AI专业能力增强框架
...
💡 **多项目支持**: 现在支持同时在多个项目中使用Perseng，项目间完全隔离！
💡 **提示**: ${registryStats.totalResources > 0 || projectConfig.resourcesDiscovered > 0 ? '项目资源已加载，使用 discover 查看所有资源' : '在 .perseng/resource 目录下创建角色和工具'}`
  }
