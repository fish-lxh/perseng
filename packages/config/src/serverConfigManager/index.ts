/**
 * @fileoverview 
 * 此文件提供了 ServerConfigManager 类，用于管理 Perseng 应用程序的服务器配置。
...
export class ServerConfigManager {
   ...
   * 构造函数
   * 
   * @param {string} [configDir] - 可选的配置目录路径，默认为用户主目录下的 .perseng
   */
  constructor(configDir?: string) {
    const defaultConfigDir = join(homedir(), '.perseng');
