/**
 * @promptx/mcp-server (npm 包名保留;本包内部品牌已迁移至 Perseng)
 *
 * MCP (Model Context Protocol) Server implementation for Perseng
 *
 * 基于Issue #317的重构设计,提供:
 * - 清晰的接口定义和职责分离
...
// 导出 Perseng 集成服务器
export { PersengMCPServer, PersengServerManager } from '~/servers/PersengMCPServer.js';
export type { PersengServerOptions } from '~/servers/PersengMCPServer.js';
