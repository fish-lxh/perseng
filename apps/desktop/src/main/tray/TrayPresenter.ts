...
export class TrayPresenter {
  ...
  private mainWindowStateCleanup: (() => void) | null = null
  ...
  private createTray(): Tray {
    ...
    tray.setToolTip('Perseng Desktop')
  ...
  public openMainWindow(): void {
    ...
    this.mainWindow = new BrowserWindow(createFramelessWindowOptions({
      width: 1400,
      height: 900,
      minWidth: 1200,
      minHeight: 760,
      title: 'Perseng Desktop',
      webPreferences: {
    ...
    applyFramelessWindowChrome(this.mainWindow)
    this.mainWindowStateCleanup = bindWindowStateSync(this.mainWindow)
    ...
    this.mainWindow.on('closed', () => {
      this.mainWindowStateCleanup?.()
      this.mainWindowStateCleanup = null
