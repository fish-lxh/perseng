...
export const AssistantEntry: React.FC<AssistantEntryProps> = ({
  ...
  const renderStatusIndicator = () => {
    switch (entry.status) {
      case "queued":
        return (
          <div className="rounded-lg px-4 py-2 bg-muted inline-block">
            <span className="font-mono text-sm text-muted-foreground tracking-wider">{t("agentxUI.chat.status.queued")}{dots}</span>
          </div>
        );
      ...
      case "processing":
        return (
          <div className="rounded-lg px-4 py-2 bg-muted inline-block">
            <span className="font-mono text-sm text-muted-foreground tracking-wider">{t("agentxUI.chat.status.processing")}{dots}</span>
          </div>
        );
      ...
      case "thinking":
        return (
          <div className="rounded-lg px-4 py-2 bg-muted inline-block">
            <span className="font-mono text-sm text-muted-foreground tracking-wider">{t("agentxUI.chat.status.thinking")}{dots}</span>
          </div>
        );
  ...
  return (
    <div className={cn("flex gap-3 py-2", className)}>
      ...
      <div className="flex-1 min-w-0 space-y-2 max-w-[60vw]">
