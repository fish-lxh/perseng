...
|_|   |_|  \\___/|_| |_| |_| .__/ \\__|/_/\\_\\
                          |_|              
`))
  console.log(chalk.yellow('Perseng Pouch Framework - AI use CLI get prompt for AI'))
  console.log('')
}
...
${chalk.cyan('Perseng Pouch Framework - AI use CLI get prompt for AI')}
...
${chalk.cyan('Six Core Commands:')}
  ...
  ${chalk.cyan('toolx')} → Execute Perseng tool ecosystem (ToolX), AI intelligent actions
